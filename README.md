Framebuffer Draw is a lightweight C++ library designed for direct pixel manipulation and drawing of 2D primitives on Linux systems using the framebuffer (/dev/fb0).
